...
export const dummyCases: Case[] = [
  ...
  },
  {
    ...
    details: 'A report from an NGO worker states that a 16-year-old girl from a financially struggling family on the outskirts of Agartala is being prepared for marriage. The ceremony is allegedly scheduled to happen within the next week to a suitor from a neighboring state.',
    status: 'Reported',
  },
];